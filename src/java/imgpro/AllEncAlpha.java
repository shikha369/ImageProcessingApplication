 ...
 /*   public double getAngle(Pix V0, Pix V1, Pix V2) {
    ...
    */
    ...
    public String startEncoding(String content) throws IOException {
        double theta;
        Pix V0, V1, V2;
        if (BoundaryList.size() <= 5) {
            if (BoundaryList.size() == 1 || BoundaryList.size() == 2) {
                content = content + 180 + " ";
            } 
            else if (BoundaryList.size() >= 3) {
            ...
            for (int i = 0; i < BoundaryList.size(); i++) {
                V0 = BoundaryList.get(i);
                System.out.println(BoundaryList.size());
                if (i == 0) {
                    V1 = BoundaryList.get(BoundaryList.size() - 5);
                } else if (i == 1) {
                    V1 = BoundaryList.get(BoundaryList.size() - 4);
                } else if (i == 2) {
                    V1 = BoundaryList.get(BoundaryList.size() - 3);
                } else if (i == 3) {
                    V1 = BoundaryList.get(BoundaryList.size() - 2);
                } else if (i == 4) {
                    V1 = BoundaryList.get(BoundaryList.size() - 1);
                } else {
                    V1 = BoundaryList.get(i - 5);
                }

                if (i == BoundaryList.size() - 5) {
                    V2 = BoundaryList.get(0);
                } else if (i == BoundaryList.size() - 4) {
                    V2 = BoundaryList.get(1);
                } else if (i == BoundaryList.size() - 3) {
                    V2 = BoundaryList.get(2);
                } else if (i == BoundaryList.size() - 2) {
                    V2 = BoundaryList.get(3);
                } else if (i == BoundaryList.size() - 1) {
                    V2 = BoundaryList.get(4);
                } else {
                    V2 = BoundaryList.get(i + 5);
                }
