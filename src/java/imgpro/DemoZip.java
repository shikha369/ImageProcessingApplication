...
public String randomFileName;
    ...
    public void ProcedureZipAndDownload(String root,String rand) throws IOException {
        ...
        File sourceMLDataCsv = new File(root+"//root"+rand+"\\MLCharacterFeaturesCsv.csv");
        File destinationMLDataCsv = new File(root+"//root"+rand+"\\ML"+rand+"\\MLCharacterFeaturesCsv.csv");

        String destination = root+"//root"+rand+"\\ML"+rand;
        ...
        try {
          ...
          // Copy ML data csv to Destination Directory
            ...
            File dir = new File(root+"//root"+rand+"\\ML"+rand);
            String zipDirName = root+"//root"+rand+"\\zippedML\\ML"+rand+".zip";

            copyFile(sourceMLDataCsv, destinationMLDataCsv);

            DemoZip zipFiles = new DemoZip();
            zipFiles.zipDirectory(dir, zipDirName);

            //rename zipped File acc. to timeStamp ..  
            File oldDir=new File(zipDirName);
            randomFileName=root+"//root"+rand+"\\zippedML\\ML"+rand;
